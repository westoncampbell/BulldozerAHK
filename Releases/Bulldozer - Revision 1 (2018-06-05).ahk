...
FontMapWrite(Text, X, Y) {
	...
	{
		T := A_LoopField
		C := (T = "A" ? 0 : T = "B" ? 16 : T = "C" ? 32 : T = "D" ? 48 : T = "E" ? 64 : T = "F" ? 80 : T = "G" ? 96 : T = "H" ? 112 : T = "I" ? 128 : T = "J" ? 144 : T = "K" ? 160 : T = "L" ? 176 : T = "M" ? 192 : T = "N" ? 208 : T = "O" ? 224 : T = "P" ? 240 : T = "Q" ? 256 : T = "R" ? 272 : T = "S" ? 288 : T = "T" ? 304 : T = "U" ? 320 : T = "V" ? 336 : T = "W" ? 352 : T = "X" ? 368 : T = "Y" ? 384 : T = "Z" ? 400 : T = ":" ? 416 : T = "0" ? 432 : T = "1" ? 448 : T = "2" ? 464 : T = "3" ? 480 : T = "4" ? 496 : T = "5" ? 512 : T = "6" ? 528 : T = "7" ? 544 : T = "8" ? 544 : T = "9" ? 560 : -16)
...
MenuHandler(ItemName, ItemPos, MenuName) {
	...
	If (MenuName = "GameMenu") {
		...
		If (ItemName = "&About Bulldozer...") {
			Gui, Main: +OwnDialogs
			MsgBox, 0x40, About Bulldozer..., Bulldozer`nRevision 1 - 2018-06-05`n`nBulldozer is a clone (with some differences) of [Bulldozer] from`n[24 Games for Windows 95] released by [Expert Software, Inc.]`n`nDeveloped for AutoHotkey by:`nWeston Campbell <westoncampbell@gmail.com>`n`nhttps://autohotkey.com/boards/viewtopic.php?f=6&t=50139
		}
	}
}

;Clone of [Bulldozer] from [24 Games for Windows 95] by [Expert
; 				Software, Inc.] https://archive.org/details/24GamesForWindows95
